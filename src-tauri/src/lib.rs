...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::download_whisper_model, commands::is_moonshine_model_installed,
            commands::download_moonshine_model, commands::get_local_transcription_gpu_status,
            ...
            speech::commands::set_speech_keyterms, speech::commands::get_speech_activity,
            speech::commands::get_moonshine_voice_support, speech::commands::get_moonshine_voice_model_status,
